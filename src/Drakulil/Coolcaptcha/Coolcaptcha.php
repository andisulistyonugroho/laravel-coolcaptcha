<?php // File: workbench/solitude/profiler/src/Drakulil/Coolcaptcha/Coolcaptcha.php
namespace Drakulil\Coolcaptcha;
...
class Coolcaptcha {
  ...
  public $session_var = 'drakulil-coolcaptcha';
  ...
  /** CI session variable handler */
  public $the_session;

  /** In constructor we set the path to coolcaptcha fonts, set of text etc **/
  public function __construct($config = array()) {
    $this->resourcesPath = __DIR__. '/resources';
  }

  /** We are going to override the configuration variables **/
  ...
  public function CreateImage() {
      ...
      /** session saving
       *  session method has been laravelized
       * **/
